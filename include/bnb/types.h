...
struct Options {
    ...
    int max_root_cut_rounds = 10;
    int max_cuts_added_per_round = 12;
    int max_root_cuts_added_per_round = 32;
    int max_cut_pool_size = 1024;
    double min_cut_violation = 1e-4;
    int max_cut_age = 8;
    double cut_age_decay = 0.05;           // decay factor used when scoring and retaining cuts
